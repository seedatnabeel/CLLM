...
def llm_gen(prompt, generator_template, format_instructions, 
            example_df, llm_serving, api_details,
            n_samples=100, temperature=0.75,
            max_tokens=8000, model='gpt4_20230815', n_processes=10,
            ic_samples=20, ):
    ...
    for i in range(500):
        ...
        try:
            ...
            messages = prompt.format_messages(data=small_data, 
            ...
            for idx in range(n_processes):
                ...
                if llm_serving=='vllm':
                    ...
                    df_tmp = df_tmp[~df_tmp.apply(lambda row: any([isinstance(cell, str) and cell in ['integer', 'float', 'numeric', 'categorical'] for cell in row]), axis=1)]
                    ...
                    if idx==0:
                        ...
                        df_check = df_check[~df_check.apply(lambda row: any([isinstance(cell, str) and cell in ['integer', 'float', 'numeric', 'categorical'] for cell in row]), axis=1)]
