...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='seer', help='Name of the dataset')
    ...
    # # apply Great
    X_syn, y_syn = great(X_train_orig, y_train_orig, n_synthetic=n_synthetic, epochs=1000, max_length=4000)
